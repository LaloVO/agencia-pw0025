            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-card border border-border rounded-2xl p-6 shadow-card">
                ...
                <div className="space-y-3">
                  <h4 className="font-serif text-lg text-slate-800 font-bold">¿No es lo que buscas?</h4>
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3 border border-[#1D4ED8] text-[#1D4ED8] hover:bg-[#1D4ED8] hover:text-white rounded-xl font-sans font-bold text-xs transition-all duration-300"
                  >
